...
class VisitControllerTest {
    ...
    // NOTES: new usages of:
    //  1. UriTemplate -  to fill in different ids like ownerId, petId
    //  2. Map<String, String> - to assign values to these ids
    //  3. URI - create URI by using UriTemplate & Map<String, String> with (expand)
